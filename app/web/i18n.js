...
const T = {
  es: {
    ...
    btn_datos: "Transparencia",
    ayuda_ver_datos: "Transparencia: fuentes, cantidades y fechas de actualización →",

    datos_eyebrow: "Transparencia: de dónde sale cada alerta",
  ...
  en: {
    ...
    btn_datos: "Transparency",
    ayuda_ver_datos: "Transparency: sources, counts and update dates →",

    datos_eyebrow: "Transparency: where every alert comes from",
